...
##' @export
registerFunctions <- function(prefix = "C_", verbose=FALSE) {
  ...
  if (verbose) cat(paste("Package name: ", pkg_name, "\n", sep = ""));
  ...
  if (verbose) cat(paste("Output file path: ", init_file_path, "\n", sep = ""));
